...
func SendbirdAccessToken() *config.Rule {
	...
	// validate
	r.TPs = utils.GenerateSampleSecrets("sendbird", secrets.NewSecret(utils.Hex("40")))
	return &r
}
...
func SendbirdAccessID() *config.Rule {
	...
	// validate
	r.TPs = utils.GenerateSampleSecrets("sendbird", secrets.NewSecret(utils.Hex8_4_4_4_12()))
	return &r
}
