...
func CloudflareGlobalAPIKey() *config.Rule {
	...
	r.TPs = append(tps, global_keys...)
	r.FPs = append(api_keys, origin_ca_keys...)
...
func CloudflareAPIKey() *config.Rule {
	...
	r.TPs = append(tps, api_keys...)
	r.FPs = append(global_keys, origin_ca_keys...)
...
func CloudflareOriginCAKey() *config.Rule {
	...
	r.TPs = append(tps, origin_ca_keys...)
	r.FPs = append(global_keys, api_keys...)
