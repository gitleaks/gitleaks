...
func main() {
	...
	configRules = append(configRules, rules.AzureStorageCredential1())
	configRules = append(configRules, rules.AzureStorageCredential2())
	configRules = append(configRules, rules.AzureStorageCredential3())
	configRules = append(configRules, rules.AzureStorageCredential4())
	configRules = append(configRules, rules.AzureStorageCredential5())
	configRules = append(configRules, rules.AzureStorageCredential6())
	configRules = append(configRules, rules.AzureStorageCredential7())
	configRules = append(configRules, rules.AzureStorageCredential8())
	configRules = append(configRules, rules.AzureStorageCredential9())
	configRules = append(configRules, rules.AzureStorageCredential10())
	configRules = append(configRules, rules.AzurePassword1())
	configRules = append(configRules, rules.AzurePassword2())
	configRules = append(configRules, rules.AzurePassword3())
	configRules = append(configRules, rules.AzurePassword4())
	configRules = append(configRules, rules.AzurePassword5())
	configRules = append(configRules, rules.AzurePassword6())
	configRules = append(configRules, rules.AzurePassword7())
	configRules = append(configRules, rules.AzurePassword8())
	configRules = append(configRules, rules.AzurePassword9())
	configRules = append(configRules, rules.AzurePassword10())
	configRules = append(configRules, rules.AzurePassword11())
	configRules = append(configRules, rules.AzurePassword12())
	configRules = append(configRules, rules.AzurePassword13())
	configRules = append(configRules, rules.AzurePassword14())
	configRules = append(configRules, rules.AzurePassword15())
	configRules = append(configRules, rules.AzureNetworkCredential1())
	configRules = append(configRules, rules.AzureNetworkCredential2())
	configRules = append(configRules, rules.AzureNetworkCredential3())
	configRules = append(configRules, rules.AzureNetworkCredential4())
	configRules = append(configRules, rules.AzureDevTFVCSecrets())
	configRules = append(configRules, rules.AzureVSTSPAT1())
	configRules = append(configRules, rules.AzureVSTSPAT2())
	configRules = append(configRules, rules.AzureVSTSPAT3())
