...
func main() {
	...
	configRules := []*config.Rule{
		...
		rules.Beamer(),
		rules.BraintreeAccessToken(),
		rules.BraintreeTokenizationKey(),
		...
		rules.MercadoPagoAccessToken(),
		rules.MercadoPagoPublicKey(),
		rules.Meraki(),
		rules.MidtransServerKey(),
		rules.MidtransClientKey(),
		...
		rules.PaystackSecretKey(),
		rules.PaystackPublicKey(),
