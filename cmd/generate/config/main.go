...
func main() {
	...
	configRules := []*config.Rule{
		...
		rules.AzureCosmosDBConnectionString(),
		rules.AzureSQLConnectionString(),
		rules.AzureDevOpsPAT(),
		rules.AzureContainerRegistryPassword(),
		rules.AzureFunctionKey(),
		rules.AzureAppConfigConnectionString(),
		rules.AzureSignalRConnectionString(),
		rules.AzureEventHubConnectionString(),
		rules.AzureIoTHubConnectionString(),
		rules.AzureBatchAccountKey(),
		rules.AzureSearchAPIKey(),
		rules.AzureMapsSubscriptionKey(),
