...
func init() {
	...
	rootCmd.PersistentFlags().StringArrayP("report-path", "r", []string{""}, "report file")
	rootCmd.PersistentFlags().StringArrayP("report-format", "f", []string{""}, "output format (json, csv, junit, sarif)")
